...
template<class T> class RosFilter
{
  public:
    ...
    bool toggleFilterProcessingCallback(sensor_fusion::ToggleFilterProcessing::Request&,
                                        sensor_fusion::ToggleFilterProcessing::Response&);
  ...
  protected:
    ...
    //! Uses a sensor_fustion ToggleFilterProcessing service.
    //!
